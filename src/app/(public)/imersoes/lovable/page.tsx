...
import { getImmersion } from '@/content/imersoes';
...
const immersion = getImmersion('lovable');
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: immersion.metaDescription,
    type: 'website',
    url: 'https://aurimarnogueira.com.br/imersoes/lovable',
  },
};

export default function ImersaoLovablePage() {
  return (
    <>
      <ImmersionHero
