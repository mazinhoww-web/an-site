...
const SKILLS = [
  {
    ...
    description: 'Arquitetura de sistemas de receita, ICP e Ideal Customer Signals, stack moderno (Clay, HubSpot, N8N) e implementação de AI-Led Growth.',
  ...
  },
  {
    ...
    description: 'SDR IA com workflow completo de nodes N8N, processamento automático de transcrições, agente de higiene de CRM e enriquecimento de lead inbound.',
    category: 'Go-to-Market',
    downloads: 289,
    featured: true,
  },
  {
    slug: 'metodo-jet-ski',
    name: 'Método Jet Ski',
    description: 'Framework de inovação em 3 fases: Diagnóstico da Oportunidade, Prototipação Ágil, Visão Transformadora. Aplicado em squads de inovação corporativa.',
    category: 'Framework',
    downloads: 521,
    featured: true,
  },
  ...
  },
  {
    ...
    description: 'Automações N8N/Make, integrações via API, Customer Data Platform (CDP), Revenue Data Platform (RDP) e arquitetura de Data Lake com Medallion.',
    category: 'Data',
    downloads: 198,
    featured: true,
  },
  ...
  },
  {
    ...
    description: 'Frameworks de onboarding com milestones, health score composto, playbooks de retenção e expansão, QBR e gestão de carteira por segmento.',
    category: 'Operations',
    downloads: 134,
  },
  {
    ...
    description: 'OKRs e North Star Metric, Google HEART framework, Jobs-to-be-Done, Continuous Discovery Habits, Product-Led Growth, priorização RICE/ICE.',
    category: 'Product',
    downloads: 112,
  },
  {
    ...
    description: 'SCRUM completo, Dual Track Agile (Discovery + Delivery paralelos) e documentação executiva acionável.',
    category: 'Agile',
    downloads: 98,
  },
  {
    ...
    description: 'Arquitetura Medallion Bronze/Silver/Gold com PySpark, pipelines ETL/ELT, orquestração com Airflow, modelagem dimensional com SCD e streaming.',
    category: 'Data',
    downloads: 87,
  },
  {
    ...
    description: 'Metodologia para transformar ideias em negócios viáveis dentro de squads corporativas, conectando Discovery, Business Case e Go-to-Market.',
    category: 'Framework',
    downloads: 156,
  },
  {
      ...
      <section className="px-6 py-20 md:px-12 md:py-32 lg:px-16">
        <div className="mx-auto max-w-container">
          ...
          <p className="mt-4 max-w-prose text-body-l text-graphite">
            ...
            Cada skill ensina o Claude a executar tarefas com o método específico.
          </p>
